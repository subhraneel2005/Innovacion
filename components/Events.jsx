...
function Events() {
  return (
    <div id='events' className="min-h-screen w-full rounded-[40px] relative z-10 -top-[40px] md:-top-[40px] border-2 border-[#16423C] md:px-[108px] shadow-[0px_0px_20px_rgba(22,66,60,1)]" >
      ...
      <GradientBox extraClass="mb-8 flex justify-center items-center flex-col my-[100px] mx-[50px]">
        <h2 className="text-4xl md:text-[3.2rem] text-center font-[Tasa-SemiBold] mb-10 text-white">About INNOVACIÓN</h2>
      ...
      <GradientBox extraClass="my-[100px] mx-[50px]">
        <h2 className="text-4xl md:text-[3.2rem] font-[Tasa-SemiBold] mb-10 text-center text-white">Events</h2>
