...
function Navbar() {
  ...
  return (
    <div className='h-[4.5rem] w-max-full hidden md:flex justify-between rounded-[10px] border-[#16423c] border-[1px] p-2 backdrop-blur-xl fixed top-0 left-0 right-0 z-50 lg:mx-40 lg:my-5'>
